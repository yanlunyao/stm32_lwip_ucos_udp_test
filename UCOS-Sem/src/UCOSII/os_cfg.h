...
#define OS_MAX_EVENTS            16//10    /* Max. number of event control blocks in your application      */
...
#define OS_MAX_QS                16// 4    /* Max. number of queue control blocks in your application      */
