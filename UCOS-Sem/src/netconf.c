...
void LwIP_Init(void)
{
  ...
  GLCD_displayStringLn(Line5, "  Keep Key button   ");
  GLCD_displayStringLn(Line6, "pressed to activate ");
  GLCD_displayStringLn(Line7, "     the server     ");
  ...
  {	
	...
	GLCD_displayStringLn(Line6, "  Server selected   ");	
  ...
  else
  {
	...
	GLCD_displayStringLn(Line5, "                    ");
	GLCD_displayStringLn(Line6, "  Client selected   ");	
	GLCD_displayStringLn(Line7, "                    ");
	Delay(LCD_DELAY);
  }
